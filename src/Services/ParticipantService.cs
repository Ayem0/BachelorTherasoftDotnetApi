...
public class ParticipantService : IParticipantService
{
    ...
    public async Task<ActionResult<ParticipantDto>> CreateAsync(CreateParticipantRequest request)
    {
        ...
        return new CreatedAtActionResult(
            ...
            routeValues: new { id = participant.Id }, 
            value: new ParticipantDto(participant)
        );  
    }
    ...
    public async Task<ActionResult> DeleteAsync(string id)
    {
        ...
        if (participant == null) return new NotFoundObjectResult("Participant not found.");

        await _participantRepository.DeleteAsync(participant);
        return new OkObjectResult("Successfully deleted participant.");
    }
    ...
    public async Task<ActionResult<ParticipantDto>> GetByIdAsync(string id)
    {
        ...
        return new OkObjectResult(new ParticipantDto(participant));
    }
