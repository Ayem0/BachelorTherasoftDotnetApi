...
//     public async Task<ActionResult<EventMemberDto?>> CreateAsync(string eventId, string memberId)
//     {

//         var existingEventMember = await _eventMemberRepository.GetByEventMemberIds(eventId, memberId);
//         if (existingEventMember != null) return new BadRequestObjectResult("Event already contains this member.");
